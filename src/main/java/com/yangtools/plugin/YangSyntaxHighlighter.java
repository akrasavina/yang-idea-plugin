...
public class YangSyntaxHighlighter extends SyntaxHighlighterBase {
  ...
  public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
    if (tokenType.equals(YangTypes.SEPARATOR)) {
      return SEPARATOR_KEYS;
    } else if (tokenType.equals(YangTypes.KEY)) {
      return KEY_KEYS;
    } else if (tokenType.equals(YangTypes.VALUE)) {
      return VALUE_KEYS;
    } else if (tokenType.equals(YangTypes.COMMENT)) {
      return COMMENT_KEYS;
